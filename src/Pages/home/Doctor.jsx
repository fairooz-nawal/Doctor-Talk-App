    ...
    return (
        <div className="card bg-base-100 shadow-sm p-5 rounded-3xl">
            ...
            <div className="flex ml-5 gap-3">
                ...
                <button className="btn border-2 border-blue-400 bg-blue-100 p-3 text-blue-400 rounded-full">{experience}</button>
            </div>
           
            <div className="card-body ">
                <h2 className="card-title font-bold">{name}</h2>
                <p className='text-gray-500'>{education},{specialty} {experience}</p>
